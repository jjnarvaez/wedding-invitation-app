/*
 * Frases para el carrusel de citas.
 *
 * Cada entrada es una frase con autor opcional.
 */

const QUOTES = [
  {
    text: "Como el primer sorbo de café por la mañana, así es nuestro amor: cálido, profundo y nuestro.",
